...
#
# Usage:
#   include(onnxruntime_external)
#   configure_onnxruntime_external()
#
# For native builds: downloads and extracts the real onnxruntime library.
# For WASM builds: does nothing (caller should provide mock libraries).
#
# Optional variables (set by caller):
#   ONNXRUNTIME_VERSION  — default: 1.22.0
#   ONNXRUNTIME_DIR      — skip download/extract if already set
#   ONNXRUNTIME_URL      — custom download URL
#
...
function(configure_onnxruntime_external)
    ...
    elseif(APPLE)
        ...
        elseif(CMAKE_SYSTEM_PROCESSOR STREQUAL armv7l)
            ...
            set(_OR_URL "https://github.com/synesthesiam/prebuilt-apps/releases/download/v1.0/onnxruntime-linux-arm32-${ONNXRUNTIME_VERSION}.tgz")
        else()
    ...
    # Put downloads and extracted artifacts in the build tree (cleanable like build/).
    ...
    if(NOT EXISTS "${_OR_DIR}")
        ...
        file(ARCHIVE_EXTRACT INPUT "${_OR_DOWNLOAD_DIR}/${_OR_FILENAME}" DESTINATION "${_OR_DOWNLOAD_DIR}")
    endif()
