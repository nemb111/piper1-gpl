...
function(configure_espeak_ng_external)
  ...
  if(NOT ARG_C_FLAGS)
    set(ARG_C_FLAGS
        "-D_FILE_OFFSET_BITS=64 -I${ARG_PREFIX}/src/${ARG_TARGET_NAME}/src/ucd-tools/src/include"
    )
  endif()
  ...
  # Guard with lib existence to avoid re-downloading/rebuilding when build dir
  # already exists.
  ...
  if(ARG_SRC_DIR AND EXISTS "${ARG_SRC_DIR}")
    ...
    ExternalProject_Add(
      ...
      BUILD_BYPRODUCTS ${_ESPEAKNG_STATIC_LIB} ${_UCD_STATIC_LIB}
  ...
  create_espeak_ng_targets(
    ${ARG_TARGET_NAME} ${_ESPEAKNG_BUILD_SRC} ${_ESPEAKNG_INSTALL_DIR}
    ${_ESPEAKNG_STATIC_LIB} ${_UCD_STATIC_LIB})
endfunction()
